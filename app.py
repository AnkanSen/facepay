...
def start():
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            if cv2.waitKey(1) == ord('a'):
                ...
                print(f"Payment Done for {identified_person}, at {current_time_} ")
        ...
        cv2.imshow('Payment Check, press "q" to exit', frame)
    ...
    names, rolls, times, l = extract_attendance()
    MESSAGE = f'Payment Done successfully by {identified_person}'
    print("Payment done registered")
